...
On going research is now focused in alternative ways of building the matrix $\mathbf L$ and in finding a quantitative bound on the spectral approximation $\textbf{Eig}\ \mathbf L \approx \textbf{Eig}\triangle_{\mathcal S_2}$.
