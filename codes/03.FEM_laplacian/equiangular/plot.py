...
# ---------------------------------------------------------
    ...
    for i in range(N):
        ...
        # ---------ANAFAST ON THIS SAMPLING DOES NOT WOR ANYMORE-------
    ...
    for ell in range(lmax+1):
        ...
        spectral_content[bw][ell] = np.sum(cl[start:end,:], axis=0)
        start = end
...
# ---------------------------------------------------------
eig_values = np.load('eig_values/eig_values_8.npy')
