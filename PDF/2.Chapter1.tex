...
\begin{wrapfigure}{r}{0.5\textwidth}	
	...
	\end{center}
	\captionof{figure}{\label{fig:Old spectrum1}Alignment of the graph Laplacian eigenvectors of the DeepSphere graph $W$, the starting point of this work, and its spectrum.}
\end{wrapfigure} 
